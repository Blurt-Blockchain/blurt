...
class ProposalContainer extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            total_vesting_fund_blurt: props.total_vesting_fund_blurt,
        };
    ...
    render() {
        ...
        return (
            <Proposal
                ...
                total_vesting_fund_blurt={total_vesting_fund_blurt}
            />
        );
    }
}
...
export default connect((state, ownProps) => {
    ...
    const total_vesting_fund_blurt = state.global.getIn([
        'props',
        'total_vesting_fund_blurt',
    ]);
    return { total_vesting_shares, total_vesting_fund_blurt, ...ownProps };
})(ProposalContainer);
