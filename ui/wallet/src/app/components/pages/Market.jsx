...
class Market extends React.Component {
    ...
    buyBlurt = (e) => {
        ...
        const amount_to_sell = parseFloat(
            ReactDOM.findDOMNode(this.refs.buyBlurt_total).value
        );
        const min_to_receive = parseFloat(
            ReactDOM.findDOMNode(this.refs.buyBlurt_amount).value
        );
    ...
    sellBlurt = (e) => {
        ...
        if (!user) return;
        const min_to_receive = parseFloat(
            ReactDOM.findDOMNode(this.refs.sellBlurt_total).value
        );
        const amount_to_sell = parseFloat(
            ReactDOM.findDOMNode(this.refs.sellBlurt_amount).value
        );
    ...
    setFormPrice = (price) => {
        ...
        this.refs.sellBlurt_price.value = p.toFixed(6);
        this.refs.buyBlurt_price.value = p.toFixed(6);

        const samount = parseFloat(this.refs.sellBlurt_amount.value);
        if (samount >= 0)
            this.refs.sellBlurt_total.value = roundDown(p * samount, 3);

        const bamount = parseFloat(this.refs.buyBlurt_amount.value);
        if (bamount >= 0)
            this.refs.buyBlurt_total.value = roundUp(p * bamount, 3);

        this.validateBuyBlurt();
        this.validateSellBlurt();
    };
    ...
    validateBuyBlurt = () => {
        const amount = parseFloat(this.refs.buyBlurt_amount.value);
        const price = parseFloat(this.refs.buyBlurt_price.value);
        const total = parseFloat(this.refs.buyBlurt_total.value);
    ...
    validateSellBlurt = () => {
        const amount = parseFloat(this.refs.sellBlurt_amount.value);
        const price = parseFloat(this.refs.sellBlurt_price.value);
        const total = parseFloat(this.refs.sellBlurt_total.value);
        const valid = amount > 0 && price > 0 && total > 0;
        const { highest_bid } = this.props.ticker;
        this.setState({
            sell_disabled: !valid,
            ...
            <div>
                ...
                <div className="row">
                    <div className="small-12 medium-6 columns">
                        ...
                        <form className="Market__orderform" onSubmit={buyBlurt}>
                            <div className="row">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => {
                                                const amount = parseFloat(
                                                    this.refs.buyBlurt_amount
                                                        .value
                                                );
                                                const price = parseFloat(
                                                    this.refs.buyBlurt_price
                                                        .value
                                                );
                                                if (amount >= 0 && price >= 0)
                                ...
                                <div className="column small-9 large-8">
                                    <div className="input-group">
                                        <input
                                            ...
                                            onChange={(e) => {
                                                const amount = parseFloat(
                                                    this.refs.sellBlurt_amount
                                                        .value
                                                );
                                                const price = parseFloat(
                                                    this.refs.sellBlurt_price
                                                        .value
                                                );
                                                if (amount >= 0 && price >= 0)
    ...
    component: connect(
        ...
        (dispatch) => ({
            ...
            placeOrder: (
                ...
                // create_order jsc 12345 "1.000 HBD" "100.000 BLURT" true 1467122240 false
