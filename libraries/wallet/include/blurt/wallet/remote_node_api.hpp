...
/**
 * This is a dummy API so that the wallet can create properly formatted API
 * calls
 */
struct remote_node_api {
  ...
  get_ops_in_block(uint32_t, bool only_virtual = true);
  ...
  vector<database_api::api_owner_authority_history_object>
      get_owner_history(account_name_type);
  optional<database_api::api_account_recovery_request_object>
      get_recovery_request(account_name_type);
  optional<condenser_api::api_escrow_object> get_escrow(account_name_type,
                                                        uint32_t);
  vector<database_api::api_withdraw_vesting_route_object>
      get_withdraw_routes(account_name_type,
                          condenser_api::withdraw_route_type);
  vector<condenser_api::api_savings_withdraw_object>
      get_savings_withdraw_from(account_name_type);
  vector<condenser_api::api_savings_withdraw_object>
      get_savings_withdraw_to(account_name_type);
  vector<condenser_api::api_vesting_delegation_object>
      get_vesting_delegations(account_name_type, account_name_type, uint32_t);
  vector<condenser_api::api_vesting_delegation_expiration_object>
      get_expiring_vesting_delegations(account_name_type, time_point_sec,
                                       uint32_t);
  vector<optional<condenser_api::api_witness_object>>
      get_witnesses(vector<witness_id_type>);
  optional<condenser_api::api_witness_object>
      get_witness_by_account(account_name_type);
  ...
  set<public_key_type>
      get_required_signatures(condenser_api::legacy_signed_transaction,
                              flat_set<public_key_type>);
  set<public_key_type>
      get_potential_signatures(condenser_api::legacy_signed_transaction);
  ...
  vector<condenser_api::discussion> get_content_replies(account_name_type,
                                                        string);
  vector<tags::tag_count_object> get_tags_used_by_author(account_name_type);
  vector<condenser_api::discussion>
      get_discussions_by_payout(tags::discussion_query);
  vector<condenser_api::discussion>
      get_post_discussions_by_payout(tags::discussion_query);
  vector<condenser_api::discussion>
      get_comment_discussions_by_payout(tags::discussion_query);
  vector<condenser_api::discussion>
      get_discussions_by_trending(tags::discussion_query);
  vector<condenser_api::discussion>
      get_discussions_by_created(tags::discussion_query);
  vector<condenser_api::discussion>
      get_discussions_by_active(tags::discussion_query);
  vector<condenser_api::discussion>
      get_discussions_by_cashout(tags::discussion_query);
  vector<condenser_api::discussion>
      get_discussions_by_votes(tags::discussion_query);
  vector<condenser_api::discussion>
      get_discussions_by_children(tags::discussion_query);
  vector<condenser_api::discussion>
      get_discussions_by_hot(tags::discussion_query);
  vector<condenser_api::discussion>
      get_discussions_by_feed(tags::discussion_query);
  vector<condenser_api::discussion>
      get_discussions_by_blog(tags::discussion_query);
  vector<condenser_api::discussion>
      get_discussions_by_comments(tags::discussion_query);
  vector<condenser_api::discussion>
      get_discussions_by_promoted(tags::discussion_query);
  vector<condenser_api::discussion>
      get_replies_by_last_update(tags::discussion_query);
  vector<condenser_api::discussion>
      get_discussions_by_author_before_date(tags::discussion_query);
  map<uint32_t, condenser_api::api_operation_object>
      get_account_history(account_name_type, uint64_t, uint32_t);
  ...
  vector<follow::api_follow_object> get_followers(account_name_type,
                                                  account_name_type,
                                                  follow::follow_type,
                                                  uint32_t);
  vector<follow::api_follow_object> get_following(account_name_type,
                                                  account_name_type,
                                                  follow::follow_type,
                                                  uint32_t);
  follow::get_follow_count_return get_follow_count(account_name_type);
  vector<follow::feed_entry> get_feed_entries(account_name_type, uint32_t,
                                              uint32_t);
  vector<follow::comment_feed_entry> get_feed(account_name_type, uint32_t,
                                              uint32_t);
  vector<follow::blog_entry> get_blog_entries(account_name_type, uint32_t,
                                              uint32_t);
  vector<follow::comment_blog_entry> get_blog(account_name_type, uint32_t,
                                              uint32_t);
  ...
  vector<condenser_api::api_proposal_object>
      list_proposals(fc::variant, uint32_t, database_api::sort_order_type,
  ...
  vector<database_api::api_proposal_vote_object>
      list_proposal_votes(fc::variant, uint32_t, database_api::sort_order_type,
                          database_api::order_direction_type,
                          database_api::proposal_status);
};
...
FC_API(blurt::wallet::remote_node_api,
       (get_version)(get_trending_tags)(get_state)(get_active_witnesses)(
           ...
           get_witnesses)(get_witness_by_account)(get_witnesses_by_vote)(
           lookup_witness_accounts)(get_witness_count)(get_transaction_hex)(
           get_transaction)(get_required_signatures)(get_potential_signatures)(
           verify_authority)(verify_account_authority)(get_active_votes)(
           get_account_votes)(get_content)(get_content_replies)(
           get_tags_used_by_author)(get_discussions_by_payout)(
           ...
           get_reblogged_by)(get_blog_authors)(list_proposals)(find_proposals)(
           list_proposal_votes))
