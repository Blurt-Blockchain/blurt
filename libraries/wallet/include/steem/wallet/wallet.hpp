...
class wallet_api
{
   public:
      ...
      /**
       * Transfer funds from one account to another. BLURT and BBD can be transferred.
       *
      ...
      /**
       * Transfer funds from one account to another using escrow. BLURT and BBD can be transferred.
       *
       * @param from The account the funds are coming from
       * @param to The account the funds are going to
       * @param agent The account acting as the agent in case of dispute
       * @param escrow_id A unique id for the escrow transfer. (from, escrow_id) must be a unique pair
       * @param sbd_amount The amount of BBD to transfer
       ...
       * @param escrow_id A unique id for the escrow transfer
       * @param sbd_amount The amount of BBD that will be released
      ...
      /**
       *  This method will convert BBD to BLURT at the current_median_history price one
      ...
      /**
       * A witness can public a price feed for the BLURT:BBD market. The median price feed is used
       * to process conversion requests from BBD to BLURT.
       *
      ...
      /**
       * Gets the current order book for BLURT:BBD
       *
       ...
       *  @param amount_to_sell The amount of either BBD or BLURT you wish to sell
       ...
       * @param daily_pay  - the amount of BBD that is being requested to be paid out daily,
