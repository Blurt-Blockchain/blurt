...
void add_authority_accounts(flat_set<account_name_type> &result,
 ...
 * - Length is between (inclusive) BLURT_MIN_ACCOUNT_NAME_LENGTH and
 * BLURT_MAX_ACCOUNT_NAME_LENGTH
 */
...
FC_REFLECT(blurt::protocol::authority,
           (weight_threshold)(account_auths)(key_auths))
FC_REFLECT_ENUM(blurt::protocol::authority::classification,
