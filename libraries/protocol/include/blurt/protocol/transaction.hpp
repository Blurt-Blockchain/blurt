...
struct signed_transaction : public transaction {
  ...
  sign(const private_key_type &key, const chain_id_type &chain_id,
  ...
  flat_set<public_key_type> get_signature_keys(
      const chain_id_type &chain_id,
...
FC_REFLECT(
    blurt::protocol::transaction,
    (ref_block_num)(ref_block_prefix)(expiration)(operations)(extensions))
FC_REFLECT_DERIVED(blurt::protocol::signed_transaction,
                   (blurt::protocol::transaction), (signatures))
FC_REFLECT_DERIVED(blurt::protocol::annotated_signed_transaction,
                   (blurt::protocol::signed_transaction),
