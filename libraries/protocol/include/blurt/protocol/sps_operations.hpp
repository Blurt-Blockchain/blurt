...
struct create_proposal_operation : public base_operation {
  ...
  /// Given link shall be a valid permlink. Must be posted by creator or at
  /// least receiver.
  string permlink;
...
struct remove_proposal_operation : public base_operation {
  ...
  void get_required_active_authorities(flat_set<account_name_type> &a) const {
    a.insert(proposal_owner);
  }
};

/** Dedicated operation to be generated during proposal payment phase to left
   info in AH related to funds transfer.
*/
struct proposal_pay_operation : public virtual_operation {
  ...
  /// Transaction id + position of operation where appeared a proposal being a
  /// source of given operation.
...
FC_REFLECT(blurt::protocol::create_proposal_operation,
           (creator)(receiver)(start_date)(end_date)(daily_pay)(subject)(
               permlink)(extensions))
FC_REFLECT(blurt::protocol::update_proposal_votes_operation,
           (voter)(proposal_ids)(approve)(extensions))
FC_REFLECT(blurt::protocol::remove_proposal_operation,
           (proposal_owner)(proposal_ids)(extensions))

FC_REFLECT(blurt::protocol::proposal_pay_operation,
