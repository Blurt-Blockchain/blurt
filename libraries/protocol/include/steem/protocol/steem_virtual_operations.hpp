...
namespace steem { namespace protocol {
   ...
   struct hardfork_blurt_operation : public virtual_operation
   {
      hardfork_blurt_operation() {}
      hardfork_blurt_operation( const account_name_type& acc, const asset& s, const asset& st, const asset& v, const asset& cs )
...
FC_REFLECT( steem::protocol::hardfork_blurt_operation, (account)(sbd_transferred)(steem_transferred)(vests_converted)(total_steem_from_vests) )
