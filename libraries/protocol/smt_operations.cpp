...
void smt_create_operation::validate()const
{
   ...
   FC_ASSERT( smt_creation_fee.amount <= STEEM_MAX_SHARE_SUPPLY, "Fee must be smaller than BLURT_MAX_SHARE_SUPPLY" );
   FC_ASSERT( is_asset_type( smt_creation_fee, STEEM_SYMBOL ) || is_asset_type( smt_creation_fee, SBD_SYMBOL ), "Fee must be BLURT or BBD" );
...
void smt_contribute_operation::validate() const
{
   ...
   FC_ASSERT( contribution.symbol == STEEM_SYMBOL, "Contributions must be made in BLURT" );
