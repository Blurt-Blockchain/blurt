...
fc::variant_object get_config() {
  ...
  result["BLURT_ACCOUNT_RECOVERY_REQUEST_EXPIRATION_PERIOD"] =
  ...
  result["BLURT_APR_PERCENT_MULTIPLY_PER_BLOCK"] =
      BLURT_APR_PERCENT_MULTIPLY_PER_BLOCK;
  result["BLURT_APR_PERCENT_MULTIPLY_PER_HOUR"] =
      BLURT_APR_PERCENT_MULTIPLY_PER_HOUR;
  result["BLURT_APR_PERCENT_MULTIPLY_PER_ROUND"] =
      BLURT_APR_PERCENT_MULTIPLY_PER_ROUND;
  result["BLURT_APR_PERCENT_SHIFT_PER_BLOCK"] =
      BLURT_APR_PERCENT_SHIFT_PER_BLOCK;
  result["BLURT_APR_PERCENT_SHIFT_PER_HOUR"] = BLURT_APR_PERCENT_SHIFT_PER_HOUR;
  result["BLURT_APR_PERCENT_SHIFT_PER_ROUND"] =
      BLURT_APR_PERCENT_SHIFT_PER_ROUND;
  result["BLURT_BANDWIDTH_AVERAGE_WINDOW_SECONDS"] =
      BLURT_BANDWIDTH_AVERAGE_WINDOW_SECONDS;
  ...
  result["BLURT_BLOCKCHAIN_PRECISION_DIGITS"] =
      BLURT_BLOCKCHAIN_PRECISION_DIGITS;
  result["BLURT_BLOCKCHAIN_HARDFORK_VERSION"] =
      BLURT_BLOCKCHAIN_HARDFORK_VERSION;
  ...
  result["BLURT_CONTENT_REWARD_PERCENT_HF21"] =
      BLURT_CONTENT_REWARD_PERCENT_HF21;
  ...
  result["BLURT_HARDFORK_REQUIRED_WITNESSES"] =
      BLURT_HARDFORK_REQUIRED_WITNESSES;
  result["BLURT_HF21_CONVERGENT_LINEAR_RECENT_CLAIMS"] =
      BLURT_HF21_CONVERGENT_LINEAR_RECENT_CLAIMS;
  result["BLURT_INFLATION_NARROWING_PERIOD"] = BLURT_INFLATION_NARROWING_PERIOD;
  result["BLURT_INFLATION_RATE_START_PERCENT"] =
      BLURT_INFLATION_RATE_START_PERCENT;
  result["BLURT_INFLATION_RATE_STOP_PERCENT"] =
      BLURT_INFLATION_RATE_STOP_PERCENT;
  ...
  result["BLURT_MAX_ASSET_WHITELIST_AUTHORITIES"] =
      BLURT_MAX_ASSET_WHITELIST_AUTHORITIES;
  ...
  result["BLURT_MIN_TRANSACTION_EXPIRATION_LIMIT"] =
  ...
  result["BLURT_RECENT_RSHARES_DECAY_TIME_HF19"] =
      BLURT_RECENT_RSHARES_DECAY_TIME_HF19;
  result["BLURT_REVERSE_AUCTION_WINDOW_SECONDS_HF21"] =
      BLURT_REVERSE_AUCTION_WINDOW_SECONDS_HF21;
  result["BLURT_ROOT_POST_PARENT"] = BLURT_ROOT_POST_PARENT;
  result["BLURT_SAVINGS_WITHDRAW_REQUEST_LIMIT"] =
  ...
  result["BLURT_VESTING_WITHDRAW_INTERVAL_SECONDS"] =
      BLURT_VESTING_WITHDRAW_INTERVAL_SECONDS;
  result["BLURT_VOTE_DUST_THRESHOLD"] = BLURT_VOTE_DUST_THRESHOLD;
  result["BLURT_VOTING_MANA_REGENERATION_SECONDS"] =
      BLURT_VOTING_MANA_REGENERATION_SECONDS;
  result["BLURT_SYMBOL"] = BLURT_SYMBOL;
  result["VESTS_SYMBOL"] = VESTS_SYMBOL;
  result["BLURT_VIRTUAL_SCHEDULE_LAP_LENGTH2"] =
      BLURT_VIRTUAL_SCHEDULE_LAP_LENGTH2;
  result["BLURT_DELEGATION_RETURN_PERIOD_HF20"] =
  ...
  result["BLURT_WITNESS_SUBSIDY_BUDGET_PERCENT"] =
      BLURT_WITNESS_SUBSIDY_BUDGET_PERCENT;
  result["BLURT_WITNESS_SUBSIDY_DECAY_PERCENT"] =
      BLURT_WITNESS_SUBSIDY_DECAY_PERCENT;
  result["BLURT_DEFAULT_ACCOUNT_SUBSIDY_DECAY"] =
      BLURT_DEFAULT_ACCOUNT_SUBSIDY_DECAY;
  result["BLURT_DEFAULT_ACCOUNT_SUBSIDY_BUDGET"] =
      BLURT_DEFAULT_ACCOUNT_SUBSIDY_BUDGET;
  result["BLURT_DECAY_BACKSTOP_PERCENT"] = BLURT_DECAY_BACKSTOP_PERCENT;
  result["BLURT_BLOCK_GENERATION_POSTPONED_TX_LIMIT"] =
      BLURT_BLOCK_GENERATION_POSTPONED_TX_LIMIT;
  result["BLURT_PENDING_TRANSACTION_EXECUTION_LIMIT"] =
  ...
  result["BLURT_PROPOSAL_MAINTENANCE_PERIOD"] =
      BLURT_PROPOSAL_MAINTENANCE_PERIOD;
  result["BLURT_PROPOSAL_MAINTENANCE_CLEANUP"] =
      BLURT_PROPOSAL_MAINTENANCE_CLEANUP;
  result["BLURT_PROPOSAL_SUBJECT_MAX_LENGTH"] =
      BLURT_PROPOSAL_SUBJECT_MAX_LENGTH;
