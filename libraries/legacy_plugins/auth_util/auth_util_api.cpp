...
auth_util_api_impl::auth_util_api_impl(blurt::app::application &_app)
    : app(_app) {}

std::shared_ptr<blurt::plugin::auth_util::auth_util_plugin>
auth_util_api_impl::get_plugin() {
...
void auth_util_api_impl::check_authority_signature(
  ...
  } else if ((args.level == "active") || (args.level == "a") ||
             (args.level == "")) {
...
check_authority_signature_result auth_util_api::check_authority_signature(
    check_authority_signature_params args) {
  check_authority_signature_result result;
