...
public:
  ...
  virtual std::string plugin_name() const override {
    return BLURT_BLOCKCHAIN_STATISTICS_PLUGIN_NAME;
  }
...
typedef multi_index_container<
    bucket_object,
    indexed_by<
        ordered_unique<tag<by_id>, member<bucket_object, bucket_id_type,
                                          &bucket_object::id>>,
        ordered_unique<tag<by_bucket>,
                       composite_key<bucket_object,
                                     member<bucket_object, uint32_t,
...
FC_REFLECT(
    blurt::blockchain_statistics::bucket_object,
    (id)(open)(seconds)(blocks)(bandwidth)(operations)(transactions)(transfers)(
        blurt_transferred)(paid_accounts_created)(mined_accounts_created)(
        root_comments)(root_comment_edits)(root_comments_deleted)(replies)(
        reply_edits)(replies_deleted)(new_root_votes)(changed_root_votes)(
        new_reply_votes)(changed_reply_votes)(payouts)(vests_paid_to_authors)(
        vests_paid_to_curators)(transfers_to_vesting)(blurt_vested)(
        new_vesting_withdrawal_requests)(modified_vesting_withdrawal_requests)(
        vesting_withdraw_rate_delta)(vesting_withdrawals_processed)(
        finished_vesting_withdrawals)(vests_withdrawn)(vests_transferred))
CHAINBASE_SET_INDEX_TYPE(blurt::blockchain_statistics::bucket_object,
                         blurt::blockchain_statistics::bucket_index)
