...
struct statistics {
  ...
  share_type blurt_transferred =
      0;                         ///< BLURT transferred from account to account
...
public:
  ...
  /**
   * @brief Gets statistics over the time window length, interval, that contains
   * time, open.
   * @param open The opening time, or a time contained within the window.
   * @param interval The size of the window for which statistics were
   * aggregated.
   * @returns Statistics for the window.
   */
  statistics get_stats_for_time(fc::time_point_sec open,
   ...
   */
  statistics get_stats_for_interval(fc::time_point_sec start,
...
FC_REFLECT(
    blurt::blockchain_statistics::statistics,
    (blocks)(bandwidth)(operations)(transactions)(transfers)(blurt_transferred)(
        accounts_created)(paid_accounts_created)(mined_accounts_created)(
        total_comments)(total_comment_edits)(total_comments_deleted)(
        root_comments)(root_comment_edits)(root_comments_deleted)(replies)(
        reply_edits)(replies_deleted)(total_votes)(new_votes)(changed_votes)(
        total_root_votes)(new_root_votes)(changed_root_votes)(
        total_reply_votes)(new_reply_votes)(changed_reply_votes)(payouts)(
        vests_paid_to_authors)(vests_paid_to_curators)(transfers_to_vesting)(
        blurt_vested)(new_vesting_withdrawal_requests)(
        modified_vesting_withdrawal_requests)(vesting_withdraw_rate_delta)(
        vesting_withdrawals_processed)(finished_vesting_withdrawals)(
