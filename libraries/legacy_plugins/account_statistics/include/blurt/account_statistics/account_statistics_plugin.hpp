...
enum account_statistics_plugin_object_types {
  ...
  account_activity_bucket_object_type =
      (BLURT_ACCOUNT_STATISTICS_SPACE_ID << 8) + 1
};

struct account_stats_bucket_object
    : public object<account_stats_bucket_object_type,
  ...
  uint32_t non_market_bandwidth =
      0;                      ///< Charged bandwidth for non-market transactions
  ...
  share_type author_rewards_total_blurt_value =
      0;                                 ///< BLURT Value of author rewards
  ...
  share_type curation_rewards_blurt_value =
      0;                     ///< BLURT Value of curation rewards
  uint32_t transfers_to = 0; ///< Account to account transfers to this account
  uint32_t transfers_from =
      0;                     ///< Account to account transfers from this account
  share_type blurt_sent = 0; ///< BLURT sent from this account
  share_type blurt_received = 0; ///< BLURT received by this account
  uint32_t transfers_to_vesting =
      0; ///< Transfers to vesting by this account. Note: Transfer to vesting
         ///< from A to B counts as a transfer from A to B followed by a vesting
         ///< deposit by B.
  ...
  uint32_t modified_vesting_withdrawal_requests =
      0; ///< Changes to vesting withdraw requests
  uint32_t vesting_withdrawals_processed =
      0; ///< Vesting withdrawals processed for this account
  ...
  share_type blurt_received_from_withdrawls =
      0; ///< BLURT received from this account's vesting withdrawals
  share_type blurt_received_from_routes =
      0; ///< BLURT received from another account's vesting withdrawals
  share_type vests_received_from_routes =
      0; ///< VESTS received from another account's vesting withdrawals
};

typedef account_stats_bucket_object::id_type account_stats_bucket_id_type;

struct account_activity_bucket_object
    : public object<account_activity_bucket_object_type,
  ...
  uint32_t active_market_and_forum_accounts =
      0; ///< Active accounts in both the market and the forum
};
...
public:
  ...
  virtual std::string plugin_name() const override {
    return BLURT_ACCOUNT_STATISTICS_PLUGIN_NAME;
  }
...
FC_REFLECT(
    blurt::account_statistics::account_stats_bucket_object,
    (id)(open)(seconds)(name)(transactions)(market_bandwidth)(
        non_market_bandwidth)(total_ops)(market_ops)(forum_ops)(root_comments)(
        root_comment_edits)(root_comments_deleted)(replies)(reply_edits)(
        replies_deleted)(new_root_votes)(changed_root_votes)(new_reply_votes)(
        changed_reply_votes)(author_reward_payouts)(author_rewards_vests)(
        author_rewards_total_blurt_value)(curation_reward_payouts)(
        curation_rewards_vests)(curation_rewards_blurt_value)(transfers_to)(
        transfers_from)(blurt_sent)(blurt_received)(transfers_to_vesting)(
        blurt_vested)(new_vests)(new_vesting_withdrawal_requests)(
        modified_vesting_withdrawal_requests)(vesting_withdrawals_processed)(
        finished_vesting_withdrawals)(vests_withdrawn)(
        blurt_received_from_withdrawls)(blurt_received_from_routes)(
        vests_received_from_routes))
// SET_INDEX_TYPE( blurt::account_statistics::account_stats_bucket_object,)

FC_REFLECT(blurt::account_statistics::account_activity_bucket_object,
           (id)(open)(seconds)(active_market_accounts)(active_forum_accounts)(
