...
template <typename E> struct schema_optional_impl : public abstract_schema {
  BLURT_SCHEMA_TEMPLATE_CLASS_BODY(schema_optional_impl)
};

template <typename E>
void schema_optional_impl<E>::get_deps(
...
void schema_optional_impl<E>::get_str_schema(std::string &s) {
  ...
  mvo("name", my_name)("type", "optional")("etype", e_type);
...
template <typename E> struct schema_reflect<fc::optional<E>> {
