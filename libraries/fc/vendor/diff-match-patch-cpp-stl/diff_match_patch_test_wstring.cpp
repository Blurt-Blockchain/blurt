...
public:
  ...
  void testDiffCommonOverlap() {
    ...
    assertEquals("diff_commonOverlap: Unicode.", 0,
                 dmp.diff_commonOverlap("fi", L"\ufb01i"));
  }
  ...
  void testDiffDelta() {
    ...
    diffs = diffList(Diff(EQUAL, string_t(L"\u0680 \000 \t %", 7)),
                     Diff(DELETE, string_t(L"\u0681 \001 \n ^", 7)),
                     Diff(INSERT, string_t(L"\u0682 \002 \\ |", 7)));
    text1 = dmp.diff_text1(diffs);
    assertEquals("diff_text1: Unicode text.",
                 string_t(L"\u0680 \000 \t %\u0681 \001 \n ^", 14), text1);
  ...
  void testDiffMain() {
    ...
    diffs =
        diffList(Diff(DELETE, "a"), Diff(INSERT, L"\u0680"), Diff(EQUAL, "x"),
                 Diff(DELETE, "\t"), Diff(INSERT, string_t("\000", 1)));
