 ...
 * Length equal to sizeof(Storage).
 *
 *  The string will serialize the same way as std::string for variant and raw
 * formats The string will sort according to the comparison operators defined
 * for Storage, this enables effecient sorting.
 */
...
template <typename Storage> struct get_typename<fixed_string<Storage>> {
