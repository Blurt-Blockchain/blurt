 ...
 * that the end user may like to see.
 */
#define ulog(FORMAT, ...)                                                      \
  FC_MULTILINE_MACRO_BEGIN                                                     \
...
#define ddump(SEQ) dlog(FC_FORMAT(SEQ), FC_FORMAT_ARG_PARAMS(SEQ))
...
// want to do, but it's useful if you're benchmarking something and suspect
// logging is causing a slowdown.
