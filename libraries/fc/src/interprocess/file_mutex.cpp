...
public:
  file_mutex_impl(const char *f) : _file_mutex(f), _reader_count(0) {}
...
int file_mutex::readers() const { return my->_reader_count.load(); }
...
bool file_mutex::try_lock_for(const microseconds &rel_time) { return false; }

bool file_mutex::try_lock_until(const time_point &abs_time) { return false; }
