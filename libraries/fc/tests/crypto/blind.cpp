  ...
  try {
    ...
    */
...

    {
      ...
      // secp256k1_scalar_get_b32((unsigned char*)&B1, (const
      // secp256k1_scalar_t*)&B2); B1 =
      // fc::variant("b2e5da56ef9f2a34d3e22fd12634bc99261e95c87b9960bf94ed3d27b30").as<fc::sha256>();
