...
static const std::string
    TEST4("abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijkl"
          "mnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu");
static char TEST5[1000001];
static const std::string
    TEST6("abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmno");
...
template <typename H> void test_big(const std::string &expected) {
...
template <typename H> void test_stream() {
  H hash(TEST1);
...
BOOST_AUTO_TEST_CASE(sha224_test) {
  init_5();
  test<fc::sha224>(TEST1,
                   "23097d223405d8228642a477bda255b32aadbce4bda0b3f7e36c9da7");
  test<fc::sha224>(TEST2,
                   "d14a028c2a3a2bc9476102bb288234c415a2b01f828ea62ac5b3e42f");
  test<fc::sha224>(TEST3,
                   "75388b16512776cc5dba5da1fd890150b0c6455cb4f58b1952522525");
  test<fc::sha224>(TEST4,
                   "c97ca9a559850ce97a04a96def6d99a9e0e0e2ab14e6b8df265fc0b3");
  test<fc::sha224>(TEST5,
...
BOOST_AUTO_TEST_CASE(sha256_test) {
  ...
  BOOST_CHECK_EQUAL(
      ...
      (std::string)fc::sha256::hash(fourth));
}
