...
using cons_stdtuple_ctor_normal =
    boost::multi_index::detail::cons_stdtuple_ctor_normal<StdTuple, N>;

template <typename StdTuple, std::size_t N = 0>
using cons_stdtuple_ctor =
    boost::multi_index::detail::cons_stdtuple_ctor<StdTuple, N>;
