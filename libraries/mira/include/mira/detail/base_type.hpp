...
struct index_applier {
  template <typename IndexSpecifierMeta, typename SuperMeta> struct apply {
...
struct nth_layer {
  BOOST_STATIC_CONSTANT(int,
                        length = boost::mpl::size<IndexSpecifierList>::value);

  typedef typename boost::mpl::eval_if_c<
      N == length,
      boost::mpl::identity<index_base<Value, IndexSpecifierList, Allocator>>,
      boost::mpl::apply2<
          index_applier, boost::mpl::at_c<IndexSpecifierList, length - 1 - N>,
