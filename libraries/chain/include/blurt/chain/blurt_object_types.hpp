...
typedef oid<change_recovery_account_request_object>
...
typedef oid<decline_voting_rights_request_object>
...
typedef oid<vesting_delegation_expiration_object>
...
template <typename T>
struct is_static_length<chainbase::oid<T>> : public boost::true_type {};
template <typename T>
struct is_static_length<fc::fixed_string<T>> : public boost::true_type {};
template <>
struct is_static_length<blurt::protocol::account_name_type>
    : public boost::true_type {};
template <>
struct is_static_length<blurt::protocol::asset_symbol_type>
    : public boost::true_type {};
template <>
struct is_static_length<blurt::protocol::asset> : public boost::true_type {};
template <>
struct is_static_length<blurt::protocol::price> : public boost::true_type {};
...
#ifndef ENABLE_MIRA
template <typename T> T unpack_from_vector(const blurt::chain::buffer_type &s) {
  try {
    T tmp;
    if (s.size()) {
...
FC_REFLECT_ENUM(
    blurt::chain::object_type,
    (dynamic_global_property_object_type)(account_object_type)(
        account_metadata_object_type)(account_authority_object_type)(
        witness_object_type)(transaction_object_type)(
        block_summary_object_type)(witness_schedule_object_type)(
        comment_object_type)(comment_content_object_type)(
        comment_vote_object_type)(witness_vote_object_type)(
        operation_object_type)(account_history_object_type)(
        hardfork_property_object_type)(withdraw_vesting_route_object_type)(
        owner_authority_history_object_type)(
        account_recovery_request_object_type)(
        change_recovery_account_request_object_type)(escrow_object_type)(
        savings_withdraw_object_type)(
        decline_voting_rights_request_object_type)(block_stats_object_type)(
        reward_fund_object_type)(vesting_delegation_object_type)(
        vesting_delegation_expiration_object_type)(proposal_object_type)(
        proposal_vote_object_type))
