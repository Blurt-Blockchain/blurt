...
class hardfork_property_object
    : public object<hardfork_property_object_type, hardfork_property_object> {
...
typedef multi_index_container<
    ...
    indexed_by<
        ordered_unique<tag<by_id>, member<hardfork_property_object,
                                          hardfork_property_object::id_type,
                                          &hardfork_property_object::id>>>,
...
CHAINBASE_SET_INDEX_TYPE(blurt::chain::hardfork_property_object,
                         blurt::chain::hardfork_property_index)
