...
FC_REFLECT( blurt::chain::witness_weight_vote_object, (id)(witness)(account)(shares) )
CHAINBASE_SET_INDEX_TYPE( blurt::chain::witness_weight_vote_object, blurt::chain::witness_weight_vote_index )
