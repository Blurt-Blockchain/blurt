...
struct chain_properties {
  ...
  /**
   * What fraction of the "stockpiled" free accounts "expire" per elected
   * witness block. Scaled so that 1 << BLURT_RD_DECAY_DENOM_SHIFT represents
   * 100% of accounts expiring.
   */
...
public:
  enum witness_schedule_type { elected, timeshare, none };

  template <typename Constructor, typename Allocator>
  witness_object(Constructor &&c, allocator<Allocator> a) : url(a) {
    c(*this);
  }
  ...
  witness_schedule_type schedule =
      none; /// How the witness was scheduled the last time it was scheduled
   ...
   * scheduled.  To update the virtual_position the following math is performed.
   *
...
typedef multi_index_container<
    witness_object,
    indexed_by<
        ordered_unique<tag<by_id>, member<witness_object, witness_id_type,
                                          &witness_object::id>>,
        ordered_unique<tag<by_name>, member<witness_object, account_name_type,
                                            &witness_object::owner>>,
        ordered_unique<tag<by_vote_name>,
                       composite_key<witness_object,
                                     member<witness_object, share_type,
                                            &witness_object::votes>,
                                     member<witness_object, account_name_type,
                                            &witness_object::owner>>,
        ...
        ordered_unique<
            ...
            composite_key<
                witness_object,
                member<witness_object, fc::uint128,
...
typedef multi_index_container<
    ...
    indexed_by<
        ordered_unique<tag<by_id>,
                       member<witness_vote_object, witness_vote_id_type,
                              &witness_vote_object::id>>,
        ordered_unique<
            tag<by_account_witness>,
            composite_key<witness_vote_object,
                          member<witness_vote_object, account_name_type,
        ...
        ordered_unique<
            ...
            composite_key<witness_vote_object,
                          ...
                          member<witness_vote_object, account_name_type,
                                 &witness_vote_object::account>>,
            composite_key_compare<std::less<account_name_type>,
                                  std::less<account_name_type>>>>, // indexed_by
...
typedef multi_index_container<
    ...
    indexed_by<ordered_unique<
        tag<by_id>, member<witness_schedule_object, witness_schedule_id_type,
...
template <>
struct is_static_length<blurt::chain::witness_vote_object>
    : public boost::true_type {};
template <>
struct is_static_length<blurt::chain::witness_schedule_object>
    : public boost::true_type {};

} // namespace mira
#endif

FC_REFLECT_ENUM(blurt::chain::witness_object::witness_schedule_type,
                (elected)(timeshare)(none))
...
FC_REFLECT(blurt::chain::witness_object,
           (id)(owner)(created)(url)(votes)(schedule)(virtual_last_update)(
...
CHAINBASE_SET_INDEX_TYPE(blurt::chain::witness_object,
                         blurt::chain::witness_index)

FC_REFLECT(blurt::chain::witness_vote_object, (id)(witness)(account))
CHAINBASE_SET_INDEX_TYPE(blurt::chain::witness_vote_object,
                         blurt::chain::witness_vote_index)

FC_REFLECT(
    blurt::chain::witness_schedule_object,
...
CHAINBASE_SET_INDEX_TYPE(blurt::chain::witness_schedule_object,
                         blurt::chain::witness_schedule_index)
