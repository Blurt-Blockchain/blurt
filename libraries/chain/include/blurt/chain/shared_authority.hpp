...
/**
 *  The purpose of this class is to represent an authority object in a manner
 * compatiable with shared memory storage.  This requires all dynamic fields to
 * be allocated with the same allocator that allocated the shared_authority.
 */
...
public:
  ...
  using account_pair_allocator_type =
      t_allocator_pair<account_name_type, weight_type>;
  using key_pair_allocator_type =
      t_allocator_pair<public_key_type, weight_type>;
...
FC_REFLECT(blurt::chain::shared_authority,
