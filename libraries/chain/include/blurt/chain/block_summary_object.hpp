...
typedef multi_index_container<
    ...
    indexed_by<ordered_unique<
        tag<by_id>, member<block_summary_object, block_summary_object::id_type,
...
template <>
struct is_static_length<blurt::chain::block_summary_object>
...
CHAINBASE_SET_INDEX_TYPE(blurt::chain::block_summary_object,
                         blurt::chain::block_summary_index)
