...
struct api_tag_object {
  api_tag_object(const tag_stats_object &o)
      : name(o.tag), total_payouts(o.total_payout), net_votes(o.net_votes),
        top_posts(o.top_posts), comments(o.comments),
...
struct discussion : public database_api::api_comment_object {
  discussion(const blurt::chain::comment_object &o,
             const blurt::chain::database &db)
...
struct discussion_query {
  ...
  set<string> select_authors; ///< list of authors to include, posts not by this
                              ///< author are filtered
  set<string> select_tags;    ///< list of tags to include, posts without these
                              ///< tags are filtered
...
public:
  ...
  DECLARE_API((get_trending_tags)(get_tags_used_by_author)(get_discussion)(
...
FC_REFLECT(blurt::plugins::tags::get_trending_tags_args, (start_tag)(limit))

FC_REFLECT(blurt::plugins::tags::get_trending_tags_return, (tags))

FC_REFLECT(blurt::plugins::tags::get_tags_used_by_author_args, (author))

FC_REFLECT(blurt::plugins::tags::tag_count_object, (tag)(count))

FC_REFLECT(blurt::plugins::tags::get_tags_used_by_author_return, (tags))

FC_REFLECT(blurt::plugins::tags::get_discussion_args, (author)(permlink))

FC_REFLECT(
    blurt::plugins::tags::discussion_query,
    (tag)(limit)(filter_tags)(select_authors)(select_tags)(truncate_body)(
        start_author)(start_permlink)(parent_author)(parent_permlink))

FC_REFLECT(blurt::plugins::tags::discussion_query_result, (discussions))
...
FC_REFLECT(blurt::plugins::tags::get_active_votes_return, (votes))
