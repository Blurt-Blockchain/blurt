...
typedef database_api::api_witness_schedule_object
    debug_get_witness_schedule_return;

typedef void_type debug_get_hardfork_property_object_args;
typedef database_api::api_hardfork_property_object
    debug_get_hardfork_property_object_return;
...
FC_REFLECT(blurt::plugins::debug_node::debug_push_blocks_return, (blocks))

FC_REFLECT(blurt::plugins::debug_node::debug_generate_blocks_until_args,
           (debug_key)(head_block_time)(generate_sparsely))

FC_REFLECT(blurt::plugins::debug_node::debug_pop_block_return, (block))

FC_REFLECT(blurt::plugins::debug_node::debug_set_hardfork_args, (hardfork_id))

FC_REFLECT(blurt::plugins::debug_node::debug_has_hardfork_return,
           (has_hardfork))

FC_REFLECT(blurt::plugins::debug_node::debug_get_json_schema_return, (schema))
