...
#define CHECK_ARG_SIZE(s)                                                      \
  FC_ASSERT(args.size() == s, "Expected #s argument(s), was ${n}",             \
            ("n", args.size()));
...
public:
  condenser_api_impl()
    ...
    _on_post_apply_block_conn = _db.add_post_apply_block_handler(
        [&](const block_notification &note) {
          on_post_apply_block(note.block);
        },
        appbase::app()
            .get_plugin<blurt::plugins::condenser_api::condenser_api_plugin>(),
        0);
  }

  DECLARE_API_IMPL((get_version)(get_trending_tags)(get_state)(
      get_active_witnesses)(get_block_header)(get_block)(get_ops_in_block)(
      get_config)(get_dynamic_global_properties)(get_chain_properties)(
      get_witness_schedule)(get_hardfork_version)(get_next_scheduled_hardfork)(
      get_reward_fund)(get_key_references)(get_accounts)(
      get_account_references)(lookup_account_names)(lookup_accounts)(
      get_account_count)(get_owner_history)(get_recovery_request)(get_escrow)(
      get_withdraw_routes)(get_savings_withdraw_from)(get_savings_withdraw_to)(
      get_vesting_delegations)(get_expiring_vesting_delegations)(get_witnesses)(
      get_witness_by_account)(get_witnesses_by_vote)(lookup_witness_accounts)(
      get_witness_count)(get_transaction_hex)(get_transaction)(
      ...
      get_discussions_by_hot)(get_discussions_by_feed)(get_discussions_by_blog)(
      get_discussions_by_comments)(get_discussions_by_promoted)(
      get_replies_by_last_update)(get_discussions_by_author_before_date)(
      get_account_history)(broadcast_transaction)(
      broadcast_transaction_synchronous)(broadcast_block)(get_followers)(
      get_following)(get_follow_count)(get_feed_entries)(get_feed)(
      get_blog_entries)(get_blog)(get_reblogged_by)(get_blog_authors)(
      list_proposals)(find_proposals)(list_proposal_votes))

  void recursively_fetch_content(state &_state, tags::discussion &root,
                                 set<string> &referenced_accounts);
  ...
  std::shared_ptr<network_broadcast_api::network_broadcast_api>
      _network_broadcast_api;
...
DEFINE_API_IMPL(condenser_api_impl, get_version) {
  CHECK_ARG_SIZE(0)
  return get_version_return(fc::string(BLURT_BLOCKCHAIN_VERSION),
...
DEFINE_API_IMPL(condenser_api_impl, get_trending_tags) {
  ...
  auto tags =
      _tags_api
          ->get_trending_tags({args[0].as<string>(), args[1].as<uint32_t>()})
          .tags;
...
DEFINE_API_IMPL(condenser_api_impl, get_state) {
  ...
  try {
    ...
    if (_tags_api) {
      auto trending_tags =
          _tags_api->get_trending_tags({std::string(), 50}).tags;
    ...
    if (part[0].size() && part[0][0] == '@') {
      ...
      _state.accounts[acnt] = extended_account(
          database_api::api_account_object(_db.get_account(acnt), _db));

      if (_tags_api)
        _state.accounts[acnt].tags_usage =
            _tags_api->get_tags_used_by_author({acnt}).tags;

      if (_follow_api) {
        _state.accounts[acnt].guest_bloggers =
            _follow_api->get_blog_authors({acnt}).blog_authors;
      }
      ...
      if (part[1] == "transfers") {
        if (_account_history_api) {
          ...
          auto history = _account_history_api
                             ->get_account_history({acnt, uint64_t(-1), 1000})
                             .history;
          for (auto &item : history) {
            ...
            case operation::tag<claim_reward_balance_operation>::value:
              if (item.second.op.visit(visitor)) {
                eacnt.transfer_history.emplace(
                    item.first,
                    api_operation_object(item.second, visitor.l_op));
              }
              break;
        ...
        if (_tags_api) {
          auto replies =
              _tags_api->get_replies_by_last_update({acnt, "", 50}).discussions;
        ...
        int count = 0;
        const auto &pidx =
            _db.get_index<comment_index, by_author_last_update>();
        ...
        if (_follow_api) {
          ...
          for (const auto &b : blog) {
            ...
            _state.content[link] =
                tags::discussion(_db.get_comment(b.author, b.permlink), _db);
        ...
        if (_follow_api) {
          ...
          for (const auto &f : feed) {
            ...
            _state.content[link] =
                tags::discussion(_db.get_comment(f.author, f.permlink), _db);
    ...
    /// pull a complete discussion
      ...
      auto wits = get_witnesses_by_vote(
          (vector<fc::variant>){fc::variant(""), fc::variant(100)});
      ...
      if (_tags_api) {
        ...
        auto trending_disc =
            _tags_api->get_discussions_by_trending(q).discussions;
      ...
      if (_tags_api) {
        ...
        q.truncate_body = 1024;
        auto trending_disc =
            _tags_api->get_post_discussions_by_payout(q).discussions;
      ...
      if (_tags_api) {
        ...
        q.truncate_body = 1024;
        auto trending_disc =
            _tags_api->get_comment_discussions_by_payout(q).discussions;
      ...
      if (_tags_api) {
        ...
        q.truncate_body = 1024;
        auto trending_disc =
            _tags_api->get_discussions_by_promoted(q).discussions;
      ...
      if (_tags_api) {
        ...
        q.truncate_body = 1024;
        auto trending_disc =
            _tags_api->get_discussions_by_children(q).discussions;
      ...
      if (_tags_api) {
        ...
        q.truncate_body = 1024;
        auto trending_disc =
            _tags_api->get_discussions_by_cashout(q).discussions;
      ...
      if (_tags_api) {
        ...
        q.truncate_body = 1024;
        auto trending_disc =
            _tags_api->get_discussions_by_active(q).discussions;
      ...
      if (_tags_api) {
        ...
        q.truncate_body = 1024;
        auto trending_disc =
            _tags_api->get_discussions_by_created(q).discussions;
      ...
      if (_tags_api) {
        ...
        auto trending_tags =
            _tags_api->get_trending_tags({std::string(), 250}).tags;
        for (const auto &t : trending_tags) {
          string name = t.name;
    ...
    for (const auto &a : accounts) {
      ...
      _state.accounts[a] = extended_account(
          database_api::api_account_object(_db.get_account(a), _db));
    }

    for (auto &d : _state.content) {
      d.second.active_votes = get_active_votes(
          {fc::variant(d.second.author), fc::variant(d.second.permlink)});
    }
...
DEFINE_API_IMPL(condenser_api_impl, get_ops_in_block) {
  FC_ASSERT(args.size() == 1 || args.size() == 2,
            "Expected 1-2 arguments, was ${n}", ("n", args.size()));
  FC_ASSERT(_account_history_api, "account_history_api_plugin not enabled.");

  auto ops =
      _account_history_api
          ->get_ops_in_block({args[0].as<uint32_t>(), args[1].as<bool>()})
          .ops;
...
DEFINE_API_IMPL(condenser_api_impl, get_dynamic_global_properties) {
  CHECK_ARG_SIZE(0)
  get_dynamic_global_properties_return gpo =
      _database_api->get_dynamic_global_properties({});
...
DEFINE_API_IMPL(condenser_api_impl, get_chain_properties) {
  CHECK_ARG_SIZE(0)
  return api_chain_properties(
      _database_api->get_witness_schedule({}).median_props);
}
...
DEFINE_API_IMPL(condenser_api_impl, get_key_references) {
  ...
  return _account_by_key_api
      ->get_key_references({args[0].as<vector<public_key_type>>()})
      .accounts;
}
  ...
  for (const auto &name : names) {
    ...
    if (itr != idx.end()) {
      results.emplace_back(
          extended_account(database_api::api_account_object(*itr, _db)));

      auto vitr =
          vidx.lower_bound(boost::make_tuple(itr->name, account_name_type()));
      while (vitr != vidx.end() && vitr->account == itr->name) {
        results.back().witness_votes.insert(
            _db.get<witness_object, by_name>(vitr->witness).owner);
        ++vitr;
      }
    }
  }
...
DEFINE_API_IMPL(condenser_api_impl, get_account_references) {
  FC_ASSERT(false, "condenser_api::get_account_references --- Needs to be "
                   "refactored for Steem.");
}

DEFINE_API_IMPL(condenser_api_impl, lookup_account_names) {
  CHECK_ARG_SIZE(1)
  vector<account_name_type> account_names =
      args[0].as<vector<account_name_type>>();
  ...
  for (auto &name : account_names) {
    ...
    if (itr) {
      result.push_back(
          api_account_object(database_api::api_account_object(*itr, _db)));
    } else {
...
DEFINE_API_IMPL(condenser_api_impl, get_owner_history) {
  CHECK_ARG_SIZE(1)
  return _database_api->find_owner_histories({args[0].as<string>()})
      .owner_auths;
}
...
DEFINE_API_IMPL(condenser_api_impl, get_recovery_request) {
  ...
  auto requests =
      _database_api
          ->find_account_recovery_requests({{args[0].as<account_name_type>()}})
          .requests;
...
DEFINE_API_IMPL(condenser_api_impl, get_escrow) {
  ...
  auto escrows =
      _database_api->list_escrows({{args}, 1, database_api::by_from_id})
          .escrows;

  if (escrows.size() && escrows[0].from == args[0].as<account_name_type>() &&
...
DEFINE_API_IMPL(condenser_api_impl, get_withdraw_routes) {
  ...
  if (destination == outgoing || destination == all) {
    auto routes = _database_api
                      ->find_withdraw_vesting_routes(
                          {account, database_api::by_withdraw_route})
                      .routes;
  ...
  if (destination == incoming || destination == all) {
    auto routes = _database_api
                      ->find_withdraw_vesting_routes(
                          {account, database_api::by_destination})
                      .routes;
    result.insert(result.end(), routes.begin(), routes.end());
  }
...
DEFINE_API_IMPL(condenser_api_impl, get_savings_withdraw_from) {
  ...
  auto withdrawals =
      _database_api->find_savings_withdrawals({args[0].as<string>()})
          .withdrawals;
...
DEFINE_API_IMPL(condenser_api_impl, get_savings_withdraw_to) {
  ...
  const auto &to_complete_idx =
      _db.get_index<savings_withdraw_index, by_to_complete>();
...
DEFINE_API_IMPL(condenser_api_impl, get_vesting_delegations) {
  FC_ASSERT(args.size() == 2 || args.size() == 3,
            "Expected 2-3 arguments, was ${n}", ("n", args.size()));
  ...
  for (auto itr = delegations.begin();
       itr != delegations.end() && itr->delegator == account; ++itr) {
...
DEFINE_API_IMPL(condenser_api_impl, get_expiring_vesting_delegations) {
  ...
  account_name_type account = args[0].as<account_name_type>();
  a.start = fc::variant((vector<variant>){
      args[0], args[1], fc::variant(vesting_delegation_expiration_id_type())});
  a.limit = args.size() == 3 ? args[2].as<uint32_t>() : 100;
  a.order = database_api::by_account_expiration;

  auto delegations =
      _database_api->list_vesting_delegation_expirations(a).delegations;
...
DEFINE_API_IMPL(condenser_api_impl, get_witness_by_account) {
  CHECK_ARG_SIZE(1)
  auto witnesses =
      _database_api->find_witnesses({{args[0].as<account_name_type>()}})
          .witnesses;
...
DEFINE_API_IMPL(condenser_api_impl, get_witnesses_by_vote) {
  ...
  if (start_name == account_name_type()) {
    ...
    auto start =
        _database_api->list_witnesses({args[0], 1, database_api::by_name});
  ...
  auto witnesses = _database_api
                       ->list_witnesses({fc::variant(start_key), limit,
                                         database_api::by_vote_name})
                       .witnesses;
...
DEFINE_API_IMPL(condenser_api_impl, lookup_witness_accounts) {
  ...
  auto witnesses =
      _database_api->list_witnesses({args[0], limit, database_api::by_name})
          .witnesses;
...
DEFINE_API_IMPL(condenser_api_impl, get_transaction) {
  ...
  return legacy_signed_transaction(_account_history_api->get_transaction(
      {args[0].as<transaction_id_type>()}));
}
...
DEFINE_API_IMPL(condenser_api_impl, get_required_signatures) {
  ...
  return _database_api
      ->get_required_signatures(
          {signed_transaction(args[0].as<legacy_signed_transaction>()),
           args[1].as<flat_set<public_key_type>>()})
      .keys;
}
...
DEFINE_API_IMPL(condenser_api_impl, verify_account_authority) {
  CHECK_ARG_SIZE(2)
  return _database_api
      ->verify_account_authority({args[0].as<account_name_type>(),
                                  args[1].as<flat_set<public_key_type>>()})
      .valid;
}
...
DEFINE_API_IMPL(condenser_api_impl, get_active_votes) {
  ...
  const auto &comment =
      _db.get_comment(args[0].as<account_name_type>(), args[1].as<string>());
  const auto &idx =
      _db.get_index<chain::comment_vote_index, chain::by_comment_voter>();
...
DEFINE_API_IMPL(condenser_api_impl, get_content) {
  ...
  auto comments = _database_api->find_comments(
      {{{args[0].as<account_name_type>(), args[1].as<string>()}}});
...
DEFINE_API_IMPL(condenser_api_impl, get_tags_used_by_author) {
  ...
  return _tags_api->get_tags_used_by_author({args[0].as<account_name_type>()})
      .tags;
}
  ...
  auto discussions =
      _tags_api
          ->get_post_discussions_by_payout(
              args[0].as<tags::get_post_discussions_by_payout_args>())
          .discussions;
  vector<discussion> result;
  ...
  auto discussions =
      _tags_api
          ->get_comment_discussions_by_payout(
              args[0].as<tags::get_comment_discussions_by_payout_args>())
          .discussions;
  vector<discussion> result;
  ...
  auto discussions =
      _tags_api
          ->get_discussions_by_created(
              args[0].as<tags::get_discussions_by_created_args>())
          .discussions;
  vector<discussion> result;
...
DEFINE_API_IMPL(condenser_api_impl, get_discussions_by_active) {
  ...
  auto discussions = _tags_api
                         ->get_discussions_by_active(
                             args[0].as<tags::get_discussions_by_active_args>())
                         .discussions;
  vector<discussion> result;
  ...
  auto discussions =
      _tags_api
          ->get_discussions_by_children(
              args[0].as<tags::get_discussions_by_children_args>())
          .discussions;
  vector<discussion> result;
...
DEFINE_API_IMPL(condenser_api_impl, get_discussions_by_hot) {
  ...
  auto discussions = _tags_api
                         ->get_discussions_by_hot(
                             args[0].as<tags::get_discussions_by_hot_args>())
                         .discussions;
  vector<discussion> result;
...
DEFINE_API_IMPL(condenser_api_impl, get_discussions_by_feed) {
  ...
  auto discussions = _tags_api
                         ->get_discussions_by_feed(
                             args[0].as<tags::get_discussions_by_feed_args>())
                         .discussions;
  vector<discussion> result;
...
DEFINE_API_IMPL(condenser_api_impl, get_discussions_by_blog) {
  ...
  auto discussions = _tags_api
                         ->get_discussions_by_blog(
                             args[0].as<tags::get_discussions_by_blog_args>())
                         .discussions;
  vector<discussion> result;
  ...
  auto discussions =
      _tags_api
          ->get_discussions_by_comments(
              args[0].as<tags::get_discussions_by_comments_args>())
          .discussions;
  vector<discussion> result;
  ...
  auto discussions =
      _tags_api
          ->get_discussions_by_promoted(
              args[0].as<tags::get_discussions_by_promoted_args>())
          .discussions;
  vector<discussion> result;
...
DEFINE_API_IMPL(condenser_api_impl, get_replies_by_last_update) {
  ...
  while (itr != last_update_idx.end() && result.size() < limit &&
    ...
    result.push_back(discussion(database_api::api_comment_object(*itr, _db)));
    set_pending_payout(result.back());
    result.back().active_votes = get_active_votes(
        {fc::variant(itr->author), fc::variant(itr->permlink)});
    ++itr;
  }
  ...
  auto discussions =
      _tags_api
          ->get_discussions_by_author_before_date(
              {args[0].as<account_name_type>(), args[1].as<string>(),
               args[2].as<time_point_sec>(), args[3].as<uint32_t>()})
          .discussions;
  vector<discussion> result;
...
DEFINE_API_IMPL(condenser_api_impl, get_account_history) {
  ...
  auto history = _account_history_api
                     ->get_account_history({args[0].as<account_name_type>(),
                                            args[1].as<uint64_t>(),
                                            args[2].as<uint32_t>()})
                     .history;
  ...
  for (auto &entry : history) {
    if (entry.second.op.visit(visitor)) {
      result.emplace(entry.first,
                     api_operation_object(entry.second, visitor.l_op));
    }
  }
...
DEFINE_API_IMPL(condenser_api_impl, broadcast_transaction) {
  ...
  FC_ASSERT(_network_broadcast_api,
            "network_broadcast_api_plugin not enabled.");
  return _network_broadcast_api->broadcast_transaction(
      {signed_transaction(args[0].as<legacy_signed_transaction>())});
}
...
DEFINE_API_IMPL(condenser_api_impl, broadcast_transaction_synchronous) {
...

  {
    ...
    FC_ASSERT(_callbacks.find(txid) == _callbacks.end(),
  ...
  try {
    /* It may look strange to call these without the lock and then lock again in
     * the case of an exception, but it is correct and avoids deadlock.
     * accept_transaction is trained along with all other writes, including
     * pushing blocks. Pushing blocks do not originate from this code path and
     * will never have this lock. However, it will trigger the
     * on_post_apply_block callback and then attempt to acquire the lock. In
     * this case, this thread will be waiting on accept_block so it can write
     * and the block thread will be waiting on this thread for the lock.
     */
    ...
    // The callback may have been cleared in the meantine, so we need to check
    // for existence.
    auto c_itr = _callbacks.find(txid);
    if (c_itr != _callbacks.end())
      _callbacks.erase(c_itr);

    // We do not need to clean up _callback_expirations because
    // on_post_apply_block handles this case.
...
DEFINE_API_IMPL(condenser_api_impl, broadcast_block) {
  ...
  return _network_broadcast_api->broadcast_block(
      {signed_block(args[0].as<legacy_signed_block>())});
}
...
DEFINE_API_IMPL(condenser_api_impl, get_followers) {
  ...
  return _follow_api
      ->get_followers(
          {args[0].as<account_name_type>(), args[1].as<account_name_type>(),
           args[2].as<follow::follow_type>(), args[3].as<uint32_t>()})
      .followers;
}
...
DEFINE_API_IMPL(condenser_api_impl, get_feed_entries) {
  ...
  return _follow_api
      ->get_feed_entries({args[0].as<account_name_type>(),
                          args[1].as<uint32_t>(),
                          args.size() == 3 ? args[2].as<uint32_t>() : 500})
      .feed;
}
...
DEFINE_API_IMPL(condenser_api_impl, get_feed) {
  ...
  auto feed =
      _follow_api
          ->get_feed({args[0].as<account_name_type>(), args[1].as<uint32_t>(),
                      args.size() == 3 ? args[2].as<uint32_t>() : 500})
          .feed;
...
DEFINE_API_IMPL(condenser_api_impl, get_blog_entries) {
  ...
  return _follow_api
      ->get_blog_entries({args[0].as<account_name_type>(),
                          args[1].as<uint32_t>(),
                          args.size() == 3 ? args[2].as<uint32_t>() : 500})
      .blog;
}
...
DEFINE_API_IMPL(condenser_api_impl, get_blog) {
  ...
  auto blog =
      _follow_api
          ->get_blog({args[0].as<account_name_type>(), args[1].as<uint32_t>(),
                      args.size() == 3 ? args[2].as<uint32_t>() : 500})
          .blog;
...
DEFINE_API_IMPL(condenser_api_impl, get_blog_authors) {
  ...
  return _follow_api->get_blog_authors({args[0].as<account_name_type>()})
      .blog_authors;
}

DEFINE_API_IMPL(condenser_api_impl, list_proposals) {
  FC_ASSERT(args.size() >= 3 && args.size() <= 5,
            "Expected 3-5 argument, was ${n}", ("n", args.size()));
  ...
  list_args.order_direction =
      args.size() > 3
          ? args[3].as<blurt::plugins::database_api::order_direction_type>()
          : database_api::ascending;
  list_args.status =
      args.size() > 4
          ? args[4].as<blurt::plugins::database_api::proposal_status>()
          : database_api::all;
  ...
  for (const auto &p : proposals)
    result.emplace_back(api_proposal_object(p));
...
DEFINE_API_IMPL(condenser_api_impl, find_proposals) {
  ...
  const auto &proposals =
      _database_api
          ->find_proposals(
              {args[0].as<vector<blurt::plugins::database_api::api_id_type>>()})
          .proposals;
 ...
 *
 */
void condenser_api_impl::recursively_fetch_content(
    state &_state, tags::discussion &root, set<string> &referenced_accounts) {
  try {
    if (root.author.size())
    ...
    if (_tags_api) {
      auto replies =
          _tags_api->get_content_replies({root.author, root.permlink})
              .discussions;
      for (auto &r : replies) {
        try {
...
void condenser_api_impl::set_pending_payout(discussion &d) {
  if (_tags_api) {
    ...
    if (itr != cidx.end() && itr->comment == d.id) {
      d.promoted =
          legacy_asset::from_asset(asset(itr->promoted_balance, BLURT_SYMBOL));
    }
  }

  asset pot;
  pot =
      _db.get_reward_fund(_db.get_comment(d.author, d.permlink)).reward_balance;

  u256 total_r2 = 0;
  total_r2 = chain::util::to256(
      _db.get_reward_fund(_db.get_comment(d.author, d.permlink)).recent_claims);
  ...
  if (total_r2 > 0) {
    ...
    vshares = d.net_rshares.value > 0
                  ? chain::util::evaluate_reward_curve(d.net_rshares.value,
    ...
    d.pending_payout_value =
        legacy_asset::from_asset(asset(static_cast<uint64_t>(r2), pot.symbol));
  }

  if (d.parent_author != BLURT_ROOT_POST_PARENT)
    d.cashout_time = _db.calculate_discussion_payout_time(
        _db.get<chain::comment_object>(d.id));
  ...
  const database_api::api_comment_object root(
      _db.get_comment(d.root_author, d.root_permlink), _db);
  ...
  try {
    ...
    if (_callbacks.size()) {
      for (size_t trx_num = 0; trx_num < b.transactions.size(); ++trx_num) {
        ...
        if (itr == _callbacks.end())
          continue;
        itr->second(broadcast_transaction_synchronous_return(
            id, block_num, int32_t(trx_num), false));
    ...
    while (true) {
      ...
      for (const transaction_id_type &txid : exp_it->second) {
        ...
        // If it's empty, that means the transaction has been confirmed and has
        // been deleted by the above check.
        if (cb_it == _callbacks.end())
          continue;

        confirmation_callback callback = cb_it->second;
        transaction_id_type txid_byval =
            txid; // can't pass in by reference as it's going to be deleted
        callback(broadcast_transaction_synchronous_return(txid_byval, block_num,
                                                          -1, true));
...
uint16_t api_account_object::_compute_voting_power(
    const database_api::api_account_object &a) {
  ...
  // vp_t1 = vp_t2 - BLURT_100_PERCENT * (t2 - t1) /
  ...
  uint64_t vp_dt =
      BLURT_100_PERCENT * dt / BLURT_VOTING_MANA_REGENERATION_SECONDS;
  ...
  if (vp_t2u >= BLURT_100_PERCENT) {
    wlog("Truncated vp_t2u to BLURT_100_PERCENT for account ${a}",
         ("a", a.name));
...
condenser_api::condenser_api() : my(new detail::condenser_api_impl()) {
...
void condenser_api::api_startup() {
  auto database =
      appbase::app().find_plugin<database_api::database_api_plugin>();
  if (database != nullptr) {
  ...
  auto account_by_key =
      appbase::app().find_plugin<account_by_key::account_by_key_api_plugin>();
  if (account_by_key != nullptr) {
    my->_account_by_key_api = account_by_key->api;
  }

  auto account_history =
      appbase::app().find_plugin<account_history::account_history_api_plugin>();
  if (account_history != nullptr) {
    my->_account_history_api = account_history->api;
  }

  auto network_broadcast =
      appbase::app()
          .find_plugin<network_broadcast_api::network_broadcast_api_plugin>();
...
DEFINE_LOCKLESS_APIS(
    condenser_api,
    (get_version)(get_config)(get_account_references)(broadcast_transaction)(
        broadcast_transaction_synchronous)(broadcast_block))

DEFINE_READ_APIS(
    condenser_api,
    (get_trending_tags)(get_state)(get_active_witnesses)(get_block_header)(
        get_block)(get_ops_in_block)(get_dynamic_global_properties)(
        get_chain_properties)(get_witness_schedule)(get_hardfork_version)(
        get_next_scheduled_hardfork)(get_reward_fund)(get_key_references)(
        get_accounts)(lookup_account_names)(lookup_accounts)(get_account_count)(
        get_owner_history)(get_recovery_request)(get_escrow)(
        get_withdraw_routes)(get_savings_withdraw_from)(
        ...
        get_followers)(get_following)(get_follow_count)(get_feed_entries)(
        get_feed)(get_blog_entries)(get_blog)(get_reblogged_by)(
        get_blog_authors)(list_proposals)(list_proposal_votes)(find_proposals))
