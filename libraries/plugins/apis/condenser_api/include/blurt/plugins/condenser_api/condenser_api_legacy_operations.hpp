...
template <typename T> struct convert_to_legacy_static_variant {
  ...
  template <typename V> void operator()(const V &v) const { legacy_sv = v; }
};

typedef static_variant<protocol::comment_payout_beneficiaries>
    legacy_comment_options_extensions;

typedef vector<legacy_comment_options_extensions>
    legacy_comment_options_extensions_type;
...
typedef create_claimed_account_operation
...
typedef set_withdraw_vesting_route_operation
...
typedef request_account_recovery_operation
...
typedef change_recovery_account_operation
    legacy_change_recovery_account_operation;
typedef cancel_transfer_from_savings_operation
...
typedef clear_null_account_balance_operation
...
struct api_chain_properties {
  ...
  operator legacy_chain_properties() const {
    ...
    props.account_creation_fee =
        legacy_blurt_asset::from_asset(asset(account_creation_fee));
...
struct legacy_account_create_operation {
  ...
  legacy_account_create_operation(const account_create_operation &op)
      : fee(legacy_asset::from_asset(op.fee)), creator(op.creator),
        new_account_name(op.new_account_name), owner(op.owner),
        active(op.active), posting(op.posting), memo_key(op.memo_key),
...
struct legacy_comment_options_operation {
  ...
  legacy_comment_options_operation(const comment_options_operation &op)
      : author(op.author), permlink(op.permlink),
        ...
        percent_blurt(op.percent_blurt), allow_votes(op.allow_votes),
        allow_curation_rewards(op.allow_curation_rewards) {
    for (const auto &e : op.extensions) {
      legacy_comment_options_extensions ext;
      e.visit(
          convert_to_legacy_static_variant<legacy_comment_options_extensions>(
              ext));
...
struct legacy_transfer_operation {
  ...
  legacy_transfer_operation(const transfer_operation &op)
      : from(op.from), to(op.to), amount(legacy_asset::from_asset(op.amount)),
        memo(op.memo) {}
...
struct legacy_escrow_transfer_operation {
  ...
  legacy_escrow_transfer_operation(const escrow_transfer_operation &op)
      : from(op.from), to(op.to), agent(op.agent), escrow_id(op.escrow_id),
        ...
        escrow_expiration(op.escrow_expiration), json_meta(op.json_meta) {}
...
struct legacy_escrow_release_operation {
  ...
  legacy_escrow_release_operation(const escrow_release_operation &op)
      : from(op.from), to(op.to), agent(op.agent), who(op.who),
        receiver(op.receiver), escrow_id(op.escrow_id),
        blurt_amount(legacy_asset::from_asset(op.blurt_amount)) {}
...
struct legacy_create_proposal_operation {
  ...
  legacy_create_proposal_operation(const create_proposal_operation &op)
      : creator(op.creator), receiver(op.receiver), start_date(op.start_date),
        end_date(op.end_date),
        daily_pay(legacy_asset::from_asset(op.daily_pay)), subject(op.subject),
...
struct legacy_witness_update_operation {
  ...
  legacy_witness_update_operation(const witness_update_operation &op)
      : owner(op.owner), url(op.url), block_signing_key(op.block_signing_key),
        fee(legacy_asset::from_asset(op.fee)) {
    props.account_creation_fee = legacy_asset::from_asset(
        op.props.account_creation_fee.to_asset<false>());
  ...
  operator witness_update_operation() const {
    ...
    op.props.account_creation_fee =
        legacy_blurt_asset::from_asset(asset(props.account_creation_fee));
...
struct legacy_transfer_from_savings_operation {
  ...
  legacy_transfer_from_savings_operation(
      ...
      : from(op.from), request_id(op.request_id), to(op.to),
        amount(legacy_asset::from_asset(op.amount)), memo(op.memo) {}
...
struct legacy_delegate_vesting_shares_operation {
  ...
  legacy_delegate_vesting_shares_operation(
      ...
      : delegator(op.delegator), delegatee(op.delegatee),
        vesting_shares(legacy_asset::from_asset(op.vesting_shares)) {}
...
struct legacy_curation_reward_operation {
  ...
  legacy_curation_reward_operation(const curation_reward_operation &op)
      : curator(op.curator), reward(legacy_asset::from_asset(op.reward)),
...
struct legacy_fill_vesting_withdraw_operation {
  ...
  legacy_fill_vesting_withdraw_operation(
      const fill_vesting_withdraw_operation &op)
      : from_account(op.from_account), to_account(op.to_account),
...
struct legacy_fill_transfer_from_savings_operation {
  ...
  legacy_fill_transfer_from_savings_operation(
      const fill_transfer_from_savings_operation &op)
      : from(op.from), to(op.to), amount(legacy_asset::from_asset(op.amount)),
        request_id(op.request_id), memo(op.memo) {}
...
struct legacy_return_vesting_delegation_operation {
  ...
  legacy_return_vesting_delegation_operation(
      const return_vesting_delegation_operation &op)
      : account(op.account),
        vesting_shares(legacy_asset::from_asset(op.vesting_shares)) {}
...
struct legacy_comment_benefactor_reward_operation {
  ...
  legacy_comment_benefactor_reward_operation(
      ...
      : benefactor(op.benefactor), author(op.author), permlink(op.permlink),
        blurt_payout(legacy_asset::from_asset(op.blurt_payout)),
        vesting_payout(legacy_asset::from_asset(op.vesting_payout)) {}
...
struct legacy_claim_account_operation {
  ...
  legacy_claim_account_operation(const claim_account_operation &op)
      : creator(op.creator), fee(legacy_asset::from_asset(op.fee)) {
...
struct legacy_proposal_pay_operation {
  ...
  legacy_proposal_pay_operation(const proposal_pay_operation &op)
      : receiver(op.receiver), payment(legacy_asset::from_asset(op.payment)),
        trx_id(op.trx_id), op_in_trx(op.op_in_trx) {}
...
typedef fc::static_variant<
    legacy_vote_operation, legacy_comment_operation, legacy_transfer_operation,
    legacy_transfer_to_vesting_operation, legacy_withdraw_vesting_operation,
    legacy_account_create_operation, legacy_witness_update_operation,
    legacy_account_witness_vote_operation,
    legacy_account_witness_proxy_operation, legacy_custom_operation,
    legacy_delete_comment_operation, legacy_custom_json_operation,
    legacy_comment_options_operation,
    legacy_set_withdraw_vesting_route_operation, legacy_claim_account_operation,
    legacy_create_claimed_account_operation,
    legacy_request_account_recovery_operation, legacy_recover_account_operation,
    legacy_change_recovery_account_operation, legacy_escrow_transfer_operation,
    legacy_escrow_dispute_operation, legacy_escrow_release_operation,
    legacy_escrow_approve_operation, legacy_transfer_to_savings_operation,
    legacy_transfer_from_savings_operation,
    legacy_cancel_transfer_from_savings_operation,
    legacy_custom_binary_operation, legacy_decline_voting_rights_operation,
    legacy_reset_account_operation, legacy_set_reset_account_operation,
    legacy_claim_reward_balance_operation,
    legacy_delegate_vesting_shares_operation,
    legacy_witness_set_properties_operation, legacy_account_update_operation,
    legacy_create_proposal_operation, legacy_update_proposal_votes_operation,
    legacy_remove_proposal_operation, legacy_author_reward_operation,
    legacy_curation_reward_operation, legacy_comment_reward_operation,
    legacy_fill_vesting_withdraw_operation, legacy_shutdown_witness_operation,
    legacy_fill_transfer_from_savings_operation, legacy_hardfork_operation,
    legacy_comment_payout_update_operation,
    legacy_return_vesting_delegation_operation,
    legacy_comment_benefactor_reward_operation,
    legacy_producer_reward_operation,
    legacy_clear_null_account_balance_operation, legacy_proposal_pay_operation,
    legacy_sps_fund_operation>
    legacy_operation;

struct legacy_operation_conversion_visitor {
  legacy_operation_conversion_visitor(legacy_operation &legacy_op)
      : l_op(legacy_op) {}
  ...
  bool operator()(const clear_null_account_balance_operation &op) const {
    l_op = op;
    return true;
  }
...
struct convert_from_legacy_operation_visitor {
  ...
  operation
  operator()(const legacy_delegate_vesting_shares_operation &op) const {
  ...
  operation
  operator()(const legacy_fill_transfer_from_savings_operation &op) const {
    return operation(fill_transfer_from_savings_operation(op));
  }

  operation
  operator()(const legacy_return_vesting_delegation_operation &op) const {
    return operation(return_vesting_delegation_operation(op));
  }

  operation
  operator()(const legacy_comment_benefactor_reward_operation &op) const {
  ...
  template <typename T> operation operator()(const T &t) const {
    return operation(t);
  }
};
...
void to_variant(const blurt::plugins::condenser_api::legacy_operation &,
                fc::variant &);
void from_variant(const fc::variant &,
                  blurt::plugins::condenser_api::legacy_operation &);

void to_variant(
    const blurt::plugins::condenser_api::legacy_comment_options_extensions &,
    fc::variant &);
void from_variant(
    const fc::variant &,
    blurt::plugins::condenser_api::legacy_comment_options_extensions &);
...
template <typename T> void old_sv_to_variant(const T &sv, fc::variant &v) {
  variant tmp;
  variants vars(2);
  vars[0] = sv.which();
...
template <typename T> void old_sv_from_variant(const fc::variant &v, T &sv) {
  auto ar = v.get_array();
  if (ar.size() < 2)
    return;
...
FC_REFLECT(blurt::plugins::condenser_api::api_chain_properties,
           (account_creation_fee)(maximum_block_size)(account_subsidy_budget)(
...
FC_REFLECT(blurt::plugins::condenser_api::legacy_transfer_to_savings_operation,
           (from)(to)(amount)(memo))
FC_REFLECT(
    blurt::plugins::condenser_api::legacy_transfer_from_savings_operation,
...
FC_REFLECT(blurt::plugins::condenser_api::legacy_transfer_operation,
           (from)(to)(amount)(memo))
FC_REFLECT(blurt::plugins::condenser_api::legacy_transfer_to_vesting_operation,
           (from)(to)(amount))
FC_REFLECT(blurt::plugins::condenser_api::legacy_withdraw_vesting_operation,
           (account)(vesting_shares))
FC_REFLECT(blurt::plugins::condenser_api::legacy_witness_update_operation,
           (owner)(url)(block_signing_key)(props)(fee))
FC_REFLECT(blurt::plugins::condenser_api::legacy_comment_options_operation,
           (author)(permlink)(max_accepted_payout)(percent_blurt)(allow_votes)(
               allow_curation_rewards)(extensions))
FC_REFLECT(blurt::plugins::condenser_api::legacy_escrow_transfer_operation,
           (from)(to)(blurt_amount)(escrow_id)(agent)(fee)(json_meta)(
               ratification_deadline)(escrow_expiration));
FC_REFLECT(blurt::plugins::condenser_api::legacy_escrow_release_operation,
           (from)(to)(agent)(who)(receiver)(escrow_id)(blurt_amount));
FC_REFLECT(blurt::plugins::condenser_api::legacy_claim_reward_balance_operation,
           (account)(reward_blurt)(reward_vests))
FC_REFLECT(
    blurt::plugins::condenser_api::legacy_delegate_vesting_shares_operation,
    (delegator)(delegatee)(vesting_shares));
FC_REFLECT(blurt::plugins::condenser_api::legacy_author_reward_operation,
           (author)(permlink)(blurt_payout)(vesting_payout))
FC_REFLECT(blurt::plugins::condenser_api::legacy_curation_reward_operation,
           (curator)(reward)(comment_author)(comment_permlink))
FC_REFLECT(blurt::plugins::condenser_api::legacy_comment_reward_operation,
           (author)(permlink)(payout))
FC_REFLECT(
    blurt::plugins::condenser_api::legacy_fill_vesting_withdraw_operation,
    (from_account)(to_account)(withdrawn)(deposited))
FC_REFLECT(
    blurt::plugins::condenser_api::legacy_fill_transfer_from_savings_operation,
    (from)(to)(amount)(request_id)(memo))
FC_REFLECT(
    blurt::plugins::condenser_api::legacy_return_vesting_delegation_operation,
    (account)(vesting_shares))
FC_REFLECT(
    blurt::plugins::condenser_api::legacy_comment_benefactor_reward_operation,
    (benefactor)(author)(permlink)(blurt_payout)(vesting_payout))
FC_REFLECT(blurt::plugins::condenser_api::legacy_producer_reward_operation,
           (producer)(vesting_shares))
FC_REFLECT(blurt::plugins::condenser_api::legacy_claim_account_operation,
           (creator)(fee)(extensions))
FC_REFLECT(blurt::plugins::condenser_api::legacy_proposal_pay_operation,
           (receiver)(payment)(trx_id)(op_in_trx))
FC_REFLECT(blurt::plugins::condenser_api::legacy_sps_fund_operation,
           (additional_funds))
FC_REFLECT(
    blurt::plugins::condenser_api::legacy_create_proposal_operation,
    (creator)(receiver)(start_date)(end_date)(daily_pay)(subject)(permlink))
