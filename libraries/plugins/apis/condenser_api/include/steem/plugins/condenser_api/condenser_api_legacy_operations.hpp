...
namespace steem { namespace plugins { namespace condenser_api {
   ...
   struct legacy_hardfork_blurt_operation
   {
      legacy_hardfork_blurt_operation() {}
      legacy_hardfork_blurt_operation( const hardfork_blurt_operation& op ) :
      account( op.account ),
      ...
      total_steem_from_vests( legacy_asset::from_asset( op.total_steem_from_vests ) )
            ...
            operator hardfork_blurt_operation()const
            {
               legacy_hardfork_blurt_operation op;
               op.account = account;
   ...
   struct legacy_operation_conversion_visitor
   {
      ...
      bool operator()( const hardfork_blurt_operation& op )const
      {
         l_op = legacy_hardfork_blurt_operation( op );
         return true;
      }
...
struct convert_from_legacy_operation_visitor
{
   ...
   operation operator()( const legacy_hardfork_blurt_operation& op )const
   {
      return operation( hardfork_blurt_operation( op ) );
   }
...
FC_REFLECT( steem::plugins::condenser_api::legacy_hardfork_blurt_operation, (account)(sbd_transferred)(steem_transferred)(vests_converted)(total_steem_from_vests) )
