...
typedef list_account_recovery_requests_return
...
typedef list_change_recovery_account_requests_return
...
typedef list_vesting_delegation_expirations_return
...
typedef list_decline_voting_rights_requests_return
...
struct list_proposals_args {
  ...
  // sorting order (ascending or descending) of the result vector. Default is
  // ascending
  order_direction_type order_direction;

  // result will contain only data with status flag set to this value. Default
  // is all
...
FC_REFLECT_ENUM(
    blurt::plugins::database_api::sort_order_type,
    (by_name)(by_proxy)(by_next_vesting_withdrawal)(by_account)(by_expiration)(
        by_effective_date)(by_vote_name)(by_schedule_time)(by_account_witness)(
        by_witness_account)(by_from_id)(by_ratification_deadline)(
        by_withdraw_route)(by_destination)(by_complete_from_id)(by_to_complete)(
        by_delegation)(by_account_expiration)(by_conversion_date)(
        by_cashout_time)(by_permlink)(by_root)(by_parent)(by_last_update)(
        by_author_last_update)(by_comment_voter)(by_voter_comment)(by_price)(
        by_symbol_contributor)(by_symbol)(by_control_account)(by_symbol_time)(
        by_creator)(by_start_date)(by_end_date)(by_total_votes)(
        by_voter_proposal)(by_proposal_voter)(by_contributor)(by_symbol_id))
...
FC_REFLECT(blurt::plugins::database_api::get_reward_funds_return, (funds))

FC_REFLECT(blurt::plugins::database_api::list_witnesses_return, (witnesses))

FC_REFLECT(blurt::plugins::database_api::find_witnesses_args, (owners))

FC_REFLECT(blurt::plugins::database_api::list_witness_votes_return, (votes))

FC_REFLECT(blurt::plugins::database_api::get_active_witnesses_return,
           (witnesses))

FC_REFLECT(blurt::plugins::database_api::list_accounts_return, (accounts))

FC_REFLECT(blurt::plugins::database_api::find_accounts_args, (accounts))
...
FC_REFLECT(blurt::plugins::database_api::find_owner_histories_args, (owner))
...
FC_REFLECT(
    blurt::plugins::database_api::find_change_recovery_account_requests_args,
    (accounts))

FC_REFLECT(blurt::plugins::database_api::list_escrows_return, (escrows))

FC_REFLECT(blurt::plugins::database_api::find_escrows_args, (from))
...
FC_REFLECT(
    blurt::plugins::database_api::list_vesting_delegation_expirations_return,
    (delegations))

FC_REFLECT(
    blurt::plugins::database_api::find_vesting_delegation_expirations_args,
    (account))

FC_REFLECT(
    blurt::plugins::database_api::list_decline_voting_rights_requests_return,
    (requests))

FC_REFLECT(
    blurt::plugins::database_api::find_decline_voting_rights_requests_args,
    (accounts))

FC_REFLECT(blurt::plugins::database_api::list_comments_return, (comments))

FC_REFLECT(blurt::plugins::database_api::find_comments_args, (comments))

FC_REFLECT(blurt::plugins::database_api::list_votes_return, (votes))

FC_REFLECT(blurt::plugins::database_api::find_votes_args, (author)(permlink))

FC_REFLECT(blurt::plugins::database_api::list_proposals_args,
           (start)(limit)(order)(order_direction)(status))

FC_REFLECT(blurt::plugins::database_api::list_proposals_return, (proposals))

FC_REFLECT(blurt::plugins::database_api::find_proposals_args, (proposal_ids))

FC_REFLECT(blurt::plugins::database_api::list_proposal_votes_return,
           (proposal_votes))

FC_REFLECT(blurt::plugins::database_api::get_transaction_hex_args, (trx))

FC_REFLECT(blurt::plugins::database_api::get_transaction_hex_return, (hex))

FC_REFLECT(blurt::plugins::database_api::get_required_signatures_args,
           (trx)(available_keys))

FC_REFLECT(blurt::plugins::database_api::get_required_signatures_return, (keys))

FC_REFLECT(blurt::plugins::database_api::get_potential_signatures_args, (trx))

FC_REFLECT(blurt::plugins::database_api::verify_authority_args, (trx))

FC_REFLECT(blurt::plugins::database_api::verify_authority_return, (valid))
...
FC_REFLECT(blurt::plugins::database_api::verify_signatures_args,
           (hash)(signatures)(required_owner)(required_active)(
               required_posting)(required_other))

FC_REFLECT(blurt::plugins::database_api::verify_signatures_return, (valid))
