...
public:
  ...
  DECLARE_API(
      ...
      (get_dynamic_global_properties)(get_witness_schedule)(
          get_hardfork_properties)(get_reward_funds)
       ...
       */
      (find_accounts)(list_owner_histories)(find_owner_histories)(
      ...
      // Comments //
      //////////////
      (list_comments)(find_comments)(list_votes)(find_votes)
       ...
       * sign for a given transaction.  This call can be used by wallets to
       * filter their set of public keys to just the relevant subset prior to
      ...
      /**
       * @return true if the signers have enough authority to authorize an
       * account
       */
      (verify_account_authority)

      /*
       * This is a general purpose API that checks signatures against accounts
       * for an arbitrary sha256 hash using the existing authority structures in
       * Steem
       */
      (verify_signatures))
