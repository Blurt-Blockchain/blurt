...
public:
  ...
  DECLARE_API((get_followers)(get_following)(get_follow_count)(
      get_feed_entries)(get_feed)(get_blog_entries)(get_blog)
              ...
              /**
               * Gets a list of authors that have had their content reblogged on
               * a given blog account
               */
              (get_blog_authors))
...
FC_REFLECT(blurt::plugins::follow::reblog_count, (author)(count));

FC_REFLECT(blurt::plugins::follow::get_followers_args,
           (account)(start)(type)(limit));

FC_REFLECT(blurt::plugins::follow::get_followers_return, (followers));

FC_REFLECT(blurt::plugins::follow::get_following_return, (following));

FC_REFLECT(blurt::plugins::follow::get_follow_count_args, (account));
...
FC_REFLECT(blurt::plugins::follow::get_feed_entries_return, (feed));

FC_REFLECT(blurt::plugins::follow::get_feed_return, (feed));

FC_REFLECT(blurt::plugins::follow::get_blog_entries_return, (blog));

FC_REFLECT(blurt::plugins::follow::get_blog_return, (blog));

FC_REFLECT(blurt::plugins::follow::get_reblogged_by_args, (author)(permlink));

FC_REFLECT(blurt::plugins::follow::get_reblogged_by_return, (accounts));

FC_REFLECT(blurt::plugins::follow::get_blog_authors_args, (blog_account));

FC_REFLECT(blurt::plugins::follow::get_blog_authors_return, (blog_authors));
