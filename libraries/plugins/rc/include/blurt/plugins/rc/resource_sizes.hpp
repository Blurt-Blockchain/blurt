...
// This header defines the resource sizes.  It is an implementation detail of
// resource_count.cpp, but you may want it if you are re-implementing
// resource_count.cpp in a client library.
...
struct state_object_size_info {
  ...
  int64_t decline_voting_rights_request_object_base_size =
      28 * STATE_BYTES_SCALE;

  // escrow_object
  int64_t escrow_object_base_size = 119 * STATE_BYTES_SCALE;

  // savigns_withdraw_object
  int64_t savings_withdraw_object_byte_size =
      64 * STATE_TRANSFER_FROM_SAVINGS_BYTE_SIZE;
  ...
  int64_t vesting_delegation_expiration_object_base_size =
      44 * STATE_BYTES_SCALE;
...
FC_REFLECT(
    ...
    (authority_base_size)(authority_account_member_size)(
        ...
        account_recovery_request_object_base_size)(comment_object_base_size)(
        ...
        escrow_object_base_size)(savings_withdraw_object_byte_size)(
        ...
        withdraw_vesting_route_object_base_size)(witness_object_base_size)(
        witness_object_url_char_size)(witness_vote_object_base_size)(
        proposal_object_base_size)(proposal_vote_object_base_size)(
        proposal_vote_object_member_size))

FC_REFLECT(
    blurt::plugins::rc::operation_exec_info,
    (account_create_operation_exec_time)(account_update_operation_exec_time)(
        ...
        claim_reward_balance_operation_exec_time)(comment_operation_exec_time)(
        comment_options_operation_exec_time)(
        create_claimed_account_operation_exec_time)(custom_operation_exec_time)(
        ...
        delete_comment_operation_exec_time)(escrow_approve_operation_exec_time)(
        escrow_dispute_operation_exec_time)(escrow_release_operation_exec_time)(
        ...
        transfer_operation_exec_time)(transfer_to_savings_operation_exec_time)(
        transfer_to_vesting_operation_exec_time)(vote_operation_exec_time)(
