 ...
 *  4. netvotes - individual accounts voting for post minus accounts voting
 * against it
 *
 *  When ever a comment is modified, all tag_objects for that comment are
 * updated to match.
 */
...
struct by_parent_children; /// all top level posts with the most discussion
                           /// (replies at all levels)
...
/**
 *  The purpose of this index is to quickly identify how popular various tags by
 * maintaining variou sums over all posts under a particular tag
 */
...
typedef multi_index_container<
    tag_stats_object,
    indexed_by<
        ordered_unique<tag<by_id>, member<tag_stats_object, tag_stats_id_type,
                                          &tag_stats_object::id>>,
        ordered_unique<tag<by_tag>, member<tag_stats_object, tag_name_type,
        ...
        ordered_non_unique< tag< by_comments >,
           ...
           >,
           composite_key_compare< std::less< tag_name_type >, std::greater<
        uint32_t > >
        >,
        ...
        */
        ordered_unique<tag<by_trending>,
                       composite_key<tag_stats_object,
                                     member<tag_stats_object, fc::uint128,
                                            &tag_stats_object::total_trending>,
                                     member<tag_stats_object, tag_name_type,
                                            &tag_stats_object::tag>>,
                       composite_key_compare<std::greater<fc::uint128>,
                                             std::less<tag_name_type>>>>,
    allocator<tag_stats_object>>
    tag_stats_index;

/**
 *  This purpose of this object is to maintain stats about which tags an author
 * uses, how frequnetly, and how many total earnings of all posts by author in
 * tag.  It also allows us to answer the question of which authors earn the most
 * in each tag category.  This helps users to discover the best bloggers to
 * follow for particular tags.
 */
...
typedef multi_index_container<
    ...
    indexed_by<
        ordered_unique<tag<by_id>,
                       member<author_tag_stats_object, author_tag_stats_id_type,
                              &author_tag_stats_object::id>>,
        ordered_unique<
        ...
        ordered_unique<
            ...
            composite_key<author_tag_stats_object,
                          ...
                          member<author_tag_stats_object, uint32_t,
                                 &author_tag_stats_object::total_posts>>,
            composite_key_compare<less<account_id_type>, less<tag_name_type>,
                                  greater<uint32_t>>>>,
...
public:
  ...
  static const std::string &name() {
    static std::string name = BLURT_TAGS_PLUGIN_NAME;
    return name;
  }
...
class tag_api : public std::enable_shared_from_this<tag_api> {
   public:
      ...
      vector<tag_stats_object> get_tags()const { return
vector<tag_stats_object>(); }
...
FC_REFLECT(blurt::plugins::tags::tag_object,
           (id)(tag)(created)(active)(cashout)(net_rshares)(net_votes)(hot)(
               trending)(promoted_balance)(children)(author)(parent)(comment))
CHAINBASE_SET_INDEX_TYPE(blurt::plugins::tags::tag_object,
                         blurt::plugins::tags::tag_index)

FC_REFLECT(
    blurt::plugins::tags::tag_stats_object,
    (id)(tag)(total_payout)(net_votes)(top_posts)(comments)(total_trending));
CHAINBASE_SET_INDEX_TYPE(blurt::plugins::tags::tag_stats_object,
                         blurt::plugins::tags::tag_stats_index)

FC_REFLECT(blurt::plugins::tags::comment_metadata, (tags));

FC_REFLECT(blurt::plugins::tags::author_tag_stats_object,
           (id)(author)(tag)(total_posts)(total_rewards))
CHAINBASE_SET_INDEX_TYPE(blurt::plugins::tags::author_tag_stats_object,
                         blurt::plugins::tags::author_tag_stats_index)
