...
public:
  ...
  template <typename Constructor, typename Allocator>
  feed_object(Constructor &&c, allocator<Allocator> a) : reblogged_by(a) {
    c(*this);
  }
...
/**
 *  This index is maintained to get an idea of which authors are resteemed by a
 * particular blogger and how frequnetly. It is designed to give an overview of
 * the type of people a blogger sponsors as well as to enable generation of
 * filter set for a blog list.
 *
...
typedef multi_index_container<
    follow_object,
    indexed_by<
        ordered_unique<tag<by_id>, member<follow_object, follow_id_type,
                                          &follow_object::id>>,
...
typedef multi_index_container<
    blog_author_stats_object,
    indexed_by<
        ordered_unique<tag<by_id>, member<blog_author_stats_object,
...
typedef multi_index_container<
    ...
    indexed_by<ordered_unique<tag<by_id>,
               ...
               ordered_unique<tag<by_account>,
                              member<follow_count_object, account_name_type,
...
FC_REFLECT(blurt::plugins::follow::follow_object,
           (id)(follower)(following)(what))
CHAINBASE_SET_INDEX_TYPE(blurt::plugins::follow::follow_object,
                         blurt::plugins::follow::follow_index)

FC_REFLECT(blurt::plugins::follow::feed_object,
           (id)(account)(first_reblogged_by)(first_reblogged_on)(reblogged_by)(
               comment)(account_feed_id))
CHAINBASE_SET_INDEX_TYPE(blurt::plugins::follow::feed_object,
                         blurt::plugins::follow::feed_index)

FC_REFLECT(blurt::plugins::follow::blog_object,
           (id)(account)(comment)(reblogged_on)(blog_feed_id))
CHAINBASE_SET_INDEX_TYPE(blurt::plugins::follow::blog_object,
                         blurt::plugins::follow::blog_index)

FC_REFLECT(blurt::plugins::follow::follow_count_object,
           (id)(account)(follower_count)(following_count))
CHAINBASE_SET_INDEX_TYPE(blurt::plugins::follow::follow_count_object,
                         blurt::plugins::follow::follow_count_index)

FC_REFLECT(blurt::plugins::follow::blog_author_stats_object,
           (id)(blogger)(guest)(count))
CHAINBASE_SET_INDEX_TYPE(blurt::plugins::follow::blog_author_stats_object,
                         blurt::plugins::follow::blog_author_stats_index);

namespace helpers {
template <> class index_statistic_provider<blurt::plugins::follow::feed_index> {
public:
  typedef blurt::plugins::follow::feed_index IndexType;
  typedef typename blurt::plugins::follow::feed_object::t_reblogged_by_container
      t_reblogged_by_container;
    ...
    if (onlyStaticInfo == false) {
      for (const auto &o : index) {
        info._item_additional_allocation +=
            o.reblogged_by.capacity() *
            sizeof(t_reblogged_by_container::value_type);
      }
    }
