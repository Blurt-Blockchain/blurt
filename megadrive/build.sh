...
docker buildx build --tag $CI_REGISTRY_IMAGE:megadrive --platform linux/arm64 --load --cache-from $CI_REGISTRY_IMAGE:megacache --cache-to $CI_REGISTRY_IMAGE:megacache --progress plain .
