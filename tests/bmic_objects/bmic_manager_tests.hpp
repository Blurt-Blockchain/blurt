...
using test_object_index = boost::multi_index_container<
    test_object,
    indexed_by<
        ordered_unique<
            tag<OrderedIndex>,
...
using test_object_index2 = boost::multi_index_container<
    test_object2,
    indexed_by<
        ordered_unique<tag<OrderedIndex2>,
                       member<test_object2, chainbase::oid<test_object2>,
                              &test_object2::id>>,
        ordered_unique<
            tag<CompositeOrderedIndex2>,
...
using test_object_index3 = boost::multi_index_container<
    test_object3,
    indexed_by<
        ordered_unique<tag<OrderedIndex3>,
                       member<test_object3, chainbase::oid<test_object3>,
                              &test_object3::id>>,
        ordered_unique<
            tag<CompositeOrderedIndex3a>,
            composite_key<test_object3,
                          member<test_object3, uint32_t, &test_object3::val>,
                          member<test_object3, uint32_t, &test_object3::val2>>>,
        ordered_unique<
            tag<CompositeOrderedIndex3b>,
            composite_key<
                test_object3,
                member<test_object3, uint32_t, &test_object3::val>,
