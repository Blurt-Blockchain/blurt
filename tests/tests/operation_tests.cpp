...
BOOST_AUTO_TEST_CASE( transfer_apply )
{
   try
   {
      ...
      BOOST_TEST_MESSAGE( "--- Test failure transfering BLURT to steem.dao" );
      op.from = "bob";
      ...
      BOOST_TEST_MESSAGE( "--- Test transfering BBD to steem.dao" );
...
BOOST_AUTO_TEST_CASE( feed_publish_apply )
{
   try
   {
      ...
      feed_publish_operation op;
      op.publisher = "alice";
      op.exchange_rate = price( ASSET( "1.000 TBD" ), ASSET( "1000.000 TESTS" ) ); // 1000 BLURT : 1 BBD
...
BOOST_AUTO_TEST_CASE( escrow_transfer_validate )
{
   try
   {
      ...
      BOOST_TEST_MESSAGE( "--- failure when sbd symbol != BBD" );
      ...
      BOOST_TEST_MESSAGE( "--- failure when fee symbol != BBD and fee symbol != BLURT" );
...
BOOST_AUTO_TEST_CASE( witness_set_properties_validate )
{
   try
   {
      ...
      BOOST_TEST_MESSAGE( "--- failure when setting new sbd_exchange_rate with BBD / BLURT" );
