...
BOOST_AUTO_TEST_CASE( smt_create_apply )
{
   try
   {
      ...
      BOOST_TEST_MESSAGE( " -- SMT create with insufficient BBD balance" );
      ...
      BOOST_TEST_MESSAGE( " -- SMT create with insufficient BLURT balance" );
      ...
      BOOST_TEST_MESSAGE( " -- Check that we cannot create an SMT with an insufficent BLURT creation fee" );
      ...
      BOOST_TEST_MESSAGE( " -- Check that we cannot create an SMT with an insufficent BBD creation fee" );
